# Generated by Django 5.2.7 on 2025-11-13 00:08

import LibraryProject.bookshelf.models
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            managers=[
                ('objects', LibraryProject.bookshelf.models.CustomUserManager()),
            ],
        ),
        migrations.CreateModel(
            name='Book',
            ...
            options={
                'ordering': ['title'],
                'permissions': [('can_view', 'Can view books'), ('can_create', 'Can create new books'), ('can_edit', 'Can edit existing books'), ('can_delete', 'Can delete books')],
            },
        ),
        migrations.CreateModel(
            name='Library',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('standard', 'Standard User'), ('librarian', 'Librarian'), ('admin', 'Admin')], default='standard', max_length=20)),
